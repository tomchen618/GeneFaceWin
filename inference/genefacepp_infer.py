...
class GeneFace2Infer:
    ...
    def load_postnet(self, postnet_dir):
        ...
        # this is changed for window Tom Chen 2024-02-26
        config_dir = self.getreal_file(postnet_dir)
        set_hparams(config_dir)
    ...
    def load_secc2video(self, head_model_dir, torso_model_dir):
        ...
        if torso_model_dir != '':
            # this is changed for window Tom Chen 2024-02-26
            config_dir = self.getreal_file(torso_model_dir)
            set_hparams(config_dir)
            # set_hparams(
            ...
            # this is changed for window Tom Chen 2024-02-26
            config_dir = self.getreal_file(head_model_dir)
            set_hparams(config_dir)
            #
            # set_hparams(
        ...
        eye_area_percents = self.dataset.eye_area_percents.clone().detach()
    ...
    def forward_audio2secc(self, batch, inp=None):
        ...
        # empty cuda cache  and set the max_split_size_mb value is 100  mbTom Chen 2024-02-26
